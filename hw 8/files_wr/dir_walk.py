...
def walk_dir(start_folder):
    head_list = ('Name obj', 'Parent dir', 'Type', 'Size obj')
    global_list_obj = []
...
def json_write(data, f_name = 'list_files.json'):
    with open(f_name, 'w') as file:
        json.dump(data, file)
    print('save json file complete')

def csv_write(data, list_heads, f_name = 'list_files.csv'):
...
def pickle_write(data, f_name = 'list_files.pickle'):
    with open(f_name, 'wb') as file:
        pickle.dump(data, file)
    print('save pickle file complete')
